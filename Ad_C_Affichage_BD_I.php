...
border-radius: 10px;
  ...
  <body>
    ...
    <h2 style="color: #0c6980;"> Affichage du Courant </h2>
       ...
       <!-- -- Code PHP----------------------------------------------------------- -->
        ...
        <?php
          ...
          foreach ($pdo->query($sql) as $row) {
            ...
            echo '<td class="bdr">'. $row['courant_c'] . '</td>';
...
<!-- Ce code HTML représente une page web qui affiche un tableau de données provenant d'une base de
 données MySQL. Voici le rôle de chaque partie du code :

La structure de base du document HTML est définie avec les balises <html>, <head>, et <body>.
Dans la balise <head>, le titre de la page est défini avec la balise <title>. De plus, la balise <meta> 
est utilisée pour spécifier la configuration de la vue sur les appareils mobiles.
