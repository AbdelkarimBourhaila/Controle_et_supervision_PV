...
border-radius: 10px;
  ...
  <body>
    ...
    <h2 style="color: #0c6980;">Affichage de Courant et Tension</h2>
      ...
      <tbody id="tbody_table_record">
       ...
       <!-- -- Code PHP----------------------------------------------------------- -->
        ...
        <?php
          ...
          $sql = 'SELECT * FROM donnees_pv_finale ORDER BY time_x DESC';
...
Dans la balise <tbody>, le code PHP est utilisé pour récupérer les données de la base de données à l'aide 
  de la classe "Database" incluse à partir du fichier "database.php". Les données sont affichées dans chaque 
  ligne du tableau à l'aide d'une boucle foreach.
