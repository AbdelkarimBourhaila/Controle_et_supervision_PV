...
<h1 > Plateforme de contrôle d'un PPV </h1>
  ...
  <form method="post" action="Ad_Login_register.php">
    ...
    <div class="input-group">
  	  <label>Clé de l’installation</label>
  	  <input type="text" name="key_Client">
  	</div>
  	<div class="input-group">
  	  <button type="submit" class="btn" name="reg_user" >S'inscrire</button>
  	</div>
  	<p>
  		Déjà membre ? <a href="Ad_login.php">Connectez-vous</a>
  	</p>
  </form>
